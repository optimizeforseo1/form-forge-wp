...
function afb_enqueue_frontend_scripts() {
    wp_enqueue_script('afb-frontend', AFB_PLUGIN_URL . 'assets/frontend.js', array('jquery'), '1.0.0', true);
    wp_enqueue_style('afb-frontend', AFB_PLUGIN_URL . 'assets/frontend.css', array(), '1.0.0');
    
    wp_localize_script('afb-frontend', 'afb_ajax', array(
